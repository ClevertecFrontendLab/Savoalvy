...
export const menuConfig: MenuConfig[] = [
    ...
    },
    {
        ...
        options: [
            ...
            { label: 'Овощные закуски', value: 'vegetable_snacks' },
            { label: 'Теплые закуски', value: 'warm_snacks' },
    ...
    },
    {
        ...
        options: [
            ...
            { label: 'Овощные', value: 'vegetable_dishes' },
            { label: 'Из птицы', value: 'poultry_dishes' },
    ...
    },
    {
        ...
        options: [
            { label: 'Закуски', value: 'vegan_snacks' },
            { label: 'Первые блюда', value: 'vegan_first_courses' },
            { label: 'Вторые блюда', value: 'vegan_second_courses' },
            { label: 'Гарниры', value: 'vegan_sides' },
